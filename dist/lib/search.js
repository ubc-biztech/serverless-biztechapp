...
const indexes_js_1 = require("../constants/indexes.js");
const algoliaClient_js_1 = require("./algoliaClient.js");
exports.default = {
    /**
     * Index multiple documents
     */
    async indexDocuments({ indexName, documents }) {
        await algoliaClient_js_1.algoliaClient.saveObjects({
            indexName,
            objects: documents
        });
    },
     ...
     */
    async retrieveTopK({ indexName, queryText, topK = indexes_js_1.OPENSEARCH_INDEX_TOP_K }) {
        // Notes from Brian
        ...
        const res = await algoliaClient_js_1.algoliaClient.searchSingleIndex({
            indexName,
            searchParams: {
                query: queryText,
