...
let googleFormToDevForm = {
  ...
  "Company Name": "aca15284-fd6c-4f9e-a083-f03bacbccc86",
  "Skills": "dff0b50a-0552-4f6c-a1ed-c9eeac11bb63"
};
...
[
  {
    "M": {
      "questionImageUrl": {"S": ""},
      "label": {"S": "What is your confirmed role? "},
      "questionId": {"S": "e79bd73c-9b27-424c-af0d-ed5b2b170675"},
      "type": {"S": "CHECKBOX"},
      "choices": {"S": "Sponsor,Keynote Speaker,Workshop Host,Networking Delegate,Panelist"},
      "required": {"BOOL": true}
    }
  },
  {
    "M": {
      "charLimit": {"N": "200"},
      "questionId": {"S": "96d4e60e-6832-4f9f-b127-ecf734cbb05f"},
      "questionImageUrl": {"S": ""},
      "label": {"S": "LinkedIn URL"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": true}
    }
  },
  {
    "M": {
      "label": {"S": "Headshot"},
      "questionId": {"S": "4026ffed-9f12-4519-8e53-11720b5cfaae"},
      "type": {"S": "UPLOAD"},
      "choices": {"S": ""},
      "required": {"BOOL": true}
    }
  ...
  {
    "M": {
      "label": {"S": "Do you have any dietary restrictions?"},
      "questionId": {"S": "12596ae4-98ad-4ed0-9b62-1d40aecb2e4a"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": true}
    }
  ...
  {
    "M": {
      "label": {"S": "Please indicate any accessibility/mobility needs below"},
      "questionId": {"S": "75f50fe7-e2b3-4e56-84db-a8e923756c23"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": false}
    }
  ...
  {
    "M": {
      "label": {"S": "What is your area of expertise? Example: UX Research, Venture Capital, Project Management"},
      "questionId": {"S": "647f5bd4-d8b8-47fc-a016-b00c6ab8afd7"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": true}
    }
  ...
  {
    "M": {
      "label": {"S": "[For Panelists & Workshop Hosts] Brief biography of current and/or past work experience, professional interests, etc. (3-4 sentences) "},
      "questionId": {"S": "9917f8fe-29c8-4a8b-8124-afc72425ba8c"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": false}
    }
  ...
  {
    "M": {
      "label": {"S": "Is there anything else that you'd like us to be aware of?"},
      "questionId": {"S": "dfe5b2e4-28f8-4f0f-b934-1f2a79a16060"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": false}
    }
  ...
  {
    "M": {
      "label": {"S": "What is your company?"},
      "questionId": {"S": "aca15284-fd6c-4f9e-a083-f03bacbccc86"},
      "type": {"S": "SKILLS"},
      "choices": {"S": "..."},
      "isSkillsQuestion": {"BOOL": true},
      "required": {"BOOL": false}
    }
  },
  {
    "M": {
      "label": {"S": "Skills"},
      "questionId": {"S": "dff0b50a-0552-4f6c-a1ed-c9eeac11bb63"},
      "type": {"S": "TEXT"},
      "choices": {"S": ""},
      "required": {"BOOL": false}
    }
