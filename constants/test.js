export const INTEGRATION_TEST_USER_EMAIL = "victorv@ubcbiztech.com";
export const INTEGRATION_TEST_PERSISTENT_USER_EMAIL = "victorv@ubcbiztech.com";
export const INTEGRATION_TEST_PERSISTENT_USER_EMAIL_2 = "victorv+2@ubcbiztech.com";
export const INTEGRATION_TEST_NON_EXISTANT_USER_EMAIL = "victorv+3@ubcbiztech.com";
...
export const INTEGRATION_TEST_MEMBER_EMAIL = "victorv@ubcbiztech.com";
export const INTEGRATION_TEST_PERSISTENT_MEMBER_EMAIL = "victorv@ubcbiztech.com";
export const INTEGRATION_TEST_PERSISTENT_MEMBER_EMAIL_2 = "victorv+2@ubcbiztech.com";
export const INTEGRATION_TEST_NON_EXISTENT_MEMBER_EMAIL = "victorv+3@ubcbiztech.com";
