...
export const getEmailTemplate = protect(Access.ADMIN, async (
...
export const createEmailTemplate = protect(Access.ADMIN, async (
  event: APIGatewayEvent,
  _ctx: LambdaContext,
  _callback: LambdaCallback,
) => {
...
export const updateEmailTemplate = protect(Access.ADMIN, async (
  event: APIGatewayEvent,
  _ctx: LambdaContext,
  _callback: LambdaCallback,
) => {
...
export const deleteEmailTemplate = protect(Access.ADMIN, async (
  event: APIGatewayEvent,
  _ctx: LambdaContext,
  _callback: LambdaCallback,
) => {
...
export const listEmailTemplates = protect(Access.ADMIN, async (
