...
export const invest = protect(Access.USER, async (event) => {
  /*
    Responsible for:
...
export const teamStatus = protect(Access.USER, async (event) => {
  /*
    Responsible for:
...
export const investments = protect(Access.USER, async (event) => {
  /*
  Responsible for:
...
export const investorStatus = protect(Access.USER, async (event) => {
  /*
  Responsible for:
