...
export const create = protect(Access.ADMIN, async (event, ctx, callback) => {
...
export const getEmailFromProfile = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
...
export const getAll = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
...
export const update = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
...
export const del = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
    if (!event.pathParameters || !event.pathParameters.id)
      throw helpers.missingIdQueryResponse("id");
...
export const createPartnerMemberships = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
    const data = JSON.parse(event.body || "{}");
...
export const grantMembership = protect(Access.ADMIN, async (event, ctx, callback) => {
  try {
    const data = JSON.parse(event.body);
